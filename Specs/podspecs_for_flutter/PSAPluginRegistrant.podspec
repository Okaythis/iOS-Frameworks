...
DESC
  ...
  s.source                = { :http => 'https://github.com/Okaythis/iOS-Frameworks/raw/f5170b055364030f4affacaf822010c9537e8014/PSAPluginRegistrant.zip' }
  s.dependency 'PSAPathProvider', '1.0.9'
